{
    ...
    "dcVipFlag": "true",
    "pCfgJs": "https://www.libvio.com/static/js/playerconfig.js",
    ...
    "dtNameR": "",
    "dtImg": "//div[@class='stui-content__thumb']//@data-original",
    "dtImgR": "",
    "dtCate": "//div[@class='stui-content__detail']//p[contains(@class,'data') and contains(text(), '类型')]/text()",
    "dtCateR": "类型：(\\S+) /\\S+ /\\S+ /\\S+",
    "dtArea": "//div[@class='stui-content__detail']//p[contains(@class,'data') and contains(text(), '类型')]/text()",
    "dtAreaR": "\\S+ /地区：(\\S+) /\\S+ /\\S+",
    "dtYear": "//div[@class='stui-content__detail']//p[contains(@class,'data') and contains(text(), '类型')]/text()",
    "dtYearR": "\\S+ /\\S+ /年份：(\\S+) /\\S+",
    "dtDirector": "//div[@class='stui-content__detail']//p[contains(@class,'data') and contains(text(), '主演')]/text()",
    "dtDirectorR": "\\S+ /导演：(\\S+)",
    "dtActor": "//div[@class='stui-content__detail']//p[contains(@class,'data') and contains(text(), '主演')]/text()",
    "dtActorR": "主演：(\\S+) /\\S+ ",
    "dtDesc": "//span[@class='detail-content']/text()",
    "dtFromNode": "//div[@class='stui-vodlist__head']//h3[contains(@class,'iconfont') and not(contains(text(),'百度云盘')) and not(contains(text(),'阿里云盘'))]",
    "dtFromName": "/text()",
    "dtFromNameR": "",
    "dtUrlNode": "//ul[contains(@class,'stui-content__playlist')]",
    "dtUrlSubNode": "li/a[not(contains(text(),'合集'))]",
    "dtUrlId": "/@href",
